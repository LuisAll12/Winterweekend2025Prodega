...
<div class="container" :class="{ 'non-clickable': !ShowRegister == false }">
    ...
    <div class="image">
        <img src="../assets/Pictures/hoheneck.jpeg" alt="Winterweekend Location" />
        <div class="Image-OverlayTitleContainer">
            <div class="Image-OverlayTitle">
                Das Verrückte Café zum Hoheneck
            </div>
        </div>
    </div>
    <div class="form">
