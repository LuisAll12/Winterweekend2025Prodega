...
<div class="container" :class="{ 'non-clickable': !ShowRegister == false }">
    ...
    <div class="image">
        <img src="../assets/Pictures/GrandBar.jpg" alt="Winterweekend Location" />
    ...
    <div class="form">
        ...
        <div class="Question3" v-else-if="QuestionNumber == 2 && timerFinished" >
            <h2 class="Question-Title">
                <br><br><br>
                Teile deine persönliche Impression der Grand Bar Singh
            </h2>
